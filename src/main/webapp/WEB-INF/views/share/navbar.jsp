...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="${contextRoot }/home">Boutique JabakLah</a>
        </div>
        <div class="collapse navbar-collapse"
            ...
            <ul class="nav navbar-nav">
                ...
                <li id="listProducts"><a
                        href="${contextRoot }/show/all/products">Voir le produit</a></li>
                <security:authorize access="hasAuthority('ADMIN')">
                    <li id="manageProducts"><a
                            href="${contextRoot }/manage/products">Gerer les produits</a></li>
                </security:authorize>
            </ul>
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            <security:authorize access="hasAuthority('USER')">
                                <li id="cart"><a href="${contextRoot}/cart/show"> <span
                                        ...
                                        class="badge">${userModel.cart.cartLines }</span> - dh
                                        ${userModel.cart.grandTotal }
                                </a></li>

                                <li role="separator" class="divider"></li>
                            </security:authorize>
                            <li id="logout"><a href="${contextRoot}/logout">Se deconnecter</a></li>
                        </ul>
                    </li>
                </security:authorize>
            </ul>
