                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        mRender: function (data, type, row) {
                            ...
                            str += '<a href="' + window.contextRoot + '/delivery/' + data + '/product" class="btn btn-info"><span class="glyphicon glyphicon-road"></span></a>';
                            if (row.quantity >= 1) {
            ...
            .validate({
                ...
                massage: {
                    name: {
                        ...
                        minlength: 'Le nom de la categorie ne doit pas être inferieur à 2 caracteres'
                    },
                    description: {
                    ...
                    if (currentCount < 1 || currentCount > 3) {
                        ...
                        bootbox
                            .alert({
                                size: 'medium',
                                title: 'Error',
                                message: 'Le nombre de produits doit être au minimum de 1 et au maximum de 3 !'
